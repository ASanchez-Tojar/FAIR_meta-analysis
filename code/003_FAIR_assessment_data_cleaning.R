...
FAIR.response.raw$MA_ID <- recode(FAIR.response.raw$MA_ID,
                                  "MA_04" = "MA_041") # error communicated by Rayyan
...
#           "data/processed_data/FAIR_assessment/FAIR_data_assessment_Form_Responses_Cleaning_Round.csv",
#           row.names=FALSE)
...
write.csv(FAIR.response.processed.final,
          "data/processed_data/FAIR_assessment/FAIR_data_assessment_final.csv",
          row.names=FALSE)
